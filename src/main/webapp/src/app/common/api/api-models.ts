...
export enum ResponseExceptionType {
    ...
    ROLE_CANNOT_DELETE_EMPLOYEE = "ROLE_CANNOT_DELETE_EMPLOYEE",
    ROLE_CANNOT_UPDATE_ADMIN = "ROLE_CANNOT_UPDATE_ADMIN",
    ROLE_CANNOT_UPDATE_EMPLOYEE = "ROLE_CANNOT_UPDATE_EMPLOYEE",
    ...
    ROLE_SET_EMPLOYEE_AUTHORITY = "ROLE_SET_EMPLOYEE_AUTHORITY",
